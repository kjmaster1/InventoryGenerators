...
public class ItemInvSurvivalistGen extends ItemInventoryGenerator {
    ...
    public ItemInvSurvivalistGen() {
        super("inv_survivalist_gen");
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(StringHelper.getInfoText("info.invgens.survivalist"));
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!player.isSneaking()) {
            player.openGui(InventoryGenerators.instance, ModGuiHandler.survivalist, world, (int) player.posX, (int) player.posY, (int) player.posZ);
        }
